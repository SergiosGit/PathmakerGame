...
public class PathDetails {
    ...
    public static void setPath_DriverControlled(double forward, double strafe, double turn)
    {
        ...
        // log forward, strafe, turn
        RobotPoseSimulation.forwardPowerToInchRate = 0.035*10;
        RobotPoseSimulation.strafePowerToInchRate = 0.035*10;
        RobotPoseSimulation.turnPowerToDegRate = 0.4/100;
